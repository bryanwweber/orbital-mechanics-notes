...
The data in @tab:planetary-mass-parameters is generated by the following script, using data from {cite}`Park2021`:
...
The data in @tab:planetary-radius-parameters is generated by the following script, using data from {cite}`Archinal2018,Archinal2019`:
